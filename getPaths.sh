...
' yn
    case $yn in
        [Yy]* ) cat dataset/user_folder/metadata/Samples_Information.csv | tr "," "\t" | sed 1d | cut -f1,16,17 > dataset/user_folder/metadata/Samples_Information_3cols.tsv.tmp;
        ...
        [Nn]* ) cat dataset/user_folder/metadata/Samples_Information.csv | tr "," "\t" | sed 1d | cut -f1,14,15 > dataset/user_folder/metadata/Samples_Information_3cols.tsv.tmp;
                sed 's/\"//g' dataset/user_folder/metadata/Samples_Information_3cols.tsv.tmp > dataset/user_folder/metadata/Samples_Information_3cols.tsv;
                rm dataset/user_folder/metadata/Samples_Information_3cols.tsv.tmp; break;;
