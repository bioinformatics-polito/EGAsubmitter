...
' yn
    case $yn in
        [Yy]* ) cat dataset/user_folder/metadata/Samples_Information.csv | tr "," "\t" | sed 1d | cut -f1,19,20 > dataset/user_folder/metadata/Samples_Information_3cols.tsv.tmp;
        ...
        [Nn]* ) cat dataset/user_folder/metadata/Samples_Information.csv | tr "," "\t" | sed 1d | cut -f1,17,18 > dataset/user_folder/metadata/Samples_Information_3cols.tsv.tmp;
                sed 's/\"//g' dataset/user_folder/metadata/Samples_Information_3cols.tsv.tmp > dataset/user_folder/metadata/Samples_Information_3cols.tsv;
                rm dataset/user_folder/metadata/Samples_Information_3cols.tsv.tmp; break;;
