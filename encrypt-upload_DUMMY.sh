...
snakemake -s local/share/snakerule/Snakefile_SFTP_encrypting-uploading --cores $cores all_crypted
...
n=$(find dataset/encrypting-uploading/crypt4gh/${PROJECT_NAME}/ -type f \( -name '*.c4gh' \) | wc -l)
if [ "$n" -ne "5" ]
then
